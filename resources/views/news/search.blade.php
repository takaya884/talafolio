        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="mb-6">
                <form action="{{ route('news.search') }}" method="GET" class="flex">
                    <input type="text" name="q" value="{{ $keyword }}" placeholder="ニュースを検索..." class="flex-1 rounded-l-md border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 shadow-sm">
            ...
            <div class="mb-4">
                <h3 class="text-lg font-medium text-gray-700 dark:text-gray-300">
                    "{{ $keyword }}" の検索結果: {{ count($articles) }}件
                </h3>
            </div>
                ...
                @else
                    <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                        <div class="p-6 text-center">
                            <p class="text-gray-600 dark:text-gray-400">検索結果が見つかりませんでした。別のキーワードで試してください。</p>
                        </div>
                    </div>
                @endif
            </div>
